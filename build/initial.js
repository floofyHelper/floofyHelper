...
exports.client3 = exports.client2 = exports.client = exports.timestamp = void 0;
...
// -------------------------------------------------------------------------------
console.log(chalk_1.default.white(exports.timestamp), chalk_1.default.underline.magentaBright('Startup'), ' Booting & connecting to database...');
        ...
        inquirer_1.default
            ...
            if (answers.environment === 'Development') {
                inquirer_1.default
                    ...
                    if (answers.development === `${exports.client.user?.username}`) {
                        ...
                        exports.client2.once('shardDisconnect', () => {
                            Promise.resolve().then(() => __importStar(require('./floofyHelper/index.js')));
                            console.log(chalk_1.default.white(exports.timestamp), chalk_1.default.underline.magentaBright('Startup'), ` Starting ${exports.client.user?.username}...`);
                        });
                    }
                    else if (answers.development === `${exports.client2.user?.username}`) {
                        exports.client.destroy();
                        exports.client.once('shardDisconnect', () => {
                            Promise.resolve().then(() => __importStar(require('./fdVerification/index.js')));
                            console.log(chalk_1.default.white(exports.timestamp), chalk_1.default.underline.magentaBright('Startup'), ` Starting ${exports.client2.user?.username}...`);
                        });
                    }
                    else if (answers.development === 'All') {
                        Promise.resolve().then(() => __importStar(require('./floofyHelper/index.js')));
                        Promise.resolve().then(() => __importStar(require('./fdVerification/index.js')));
                        console.log(chalk_1.default.white(exports.timestamp), chalk_1.default.underline.magentaBright('Startup'), ` Starting ${exports.client.user?.username} and ${exports.client2.user?.username}...`);
                    }
                });
            }
                ...
                inquirer_1.default
                    ...
                    {
                        type: 'list',
                        message: `Are you sure? ${chalk_1.default.red('(This will boot the bot to')} ${chalk_1.default.red.underline('every')} ${chalk_1.default.redBright('server!)')}`,
                        name: 'production',
                        choices: [
                            {
                                name: 'No',
                    ...
                    if (answers.production === 'No') {
                        console.log(chalk_1.default.yellowBright.bold('Killing instance, restart bot to deploy'));
                        node_process_1.default;
                    }
                    if (answers.production === 'Yes') {
                        console.log(chalk_1.default.white(exports.timestamp), chalk_1.default.magentaBright.underline('Startup'), ' Please wait...');
                        dotenv.config({
                            path: '.env.production',
                            override: true,
                        });
